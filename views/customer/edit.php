...
<?php echo form_open('customer/edit/'.$customer['customer_id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input type="text" name="customer_phone" value="<?php echo ($this->input->post('customer_phone') ? $this->input->post('customer_phone') : $customer['customer_phone']); ?>" class="form-control" id="customer_phone" />
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input type="text" name="customer_address" value="<?php echo ($this->input->post('customer_address') ? $this->input->post('customer_address') : $customer['customer_address']); ?>" class="form-control" id="customer_address" />
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			<input type="text" name="customer_email" value="<?php echo ($this->input->post('customer_email') ? $this->input->post('customer_email') : $customer['customer_email']); ?>" class="form-control" id="customer_email" />
		</div>
	</div>
	<div class="form-group">
		<label for="sales_person_id" class="col-md-2 control-label">Sales Person Id</label>
		<div class="col-md-10">
...
foreach($resset as $r){             
   $product_cat_values[$r->userid]=$r->name;
				...
				{
					$selected = ($value == $customer['sales_person_id']) ? ' selected="selected"' : "";
